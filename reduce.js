/*
QUESTIONS:
1. #2 why order vowel.indexOf(lowerCase) and not lowerCase.indexOf(vowel)
2. #3 walk through logic not understanding what matches to what/logic
3. #3 why not returning [] instead arr
*/
